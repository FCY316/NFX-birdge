...
export const evmCAddress: {
  ...
  1678: {
    ...
    erc20: {
      ...
      address: process.env.REACT_APP_1678_ERC20_ADDRESS as string, // 从环境变量中获取 ERC20 合约地址，若未设置则使用默认地址
      abi: rec20, // 引入的 USDT 合约 ABI（ERC20 格式）
    },
    // 桥的合约配置
    bridge: {
      // address: "0xDdAd48Bd32bD485e12bd8115b49cd761e6859b5f",
      address: process.env.REACT_APP_1678_BRIDGE_ADDRESS as string, // 从环境变量中获取 Bridge 合约地址，若未设置则使用默认地址
      abi: bridge,
    },
  },
  56: {
